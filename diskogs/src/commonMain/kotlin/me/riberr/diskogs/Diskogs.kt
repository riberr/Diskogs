...
import io.ktor.http.*
import me.riberr.diskogs.oauth.AccessToken
import me.riberr.diskogs.oauth.RequestToken
import me.riberr.diskogs.oauth.accessToken
import me.riberr.diskogs.oauth.requestToken
import me.riberr.diskogs.util.epochMillis

class Diskogs private constructor(
    ...
    companion object {
        ...
        private fun getUserAgent(s: String?): String {
            ...
            return if (s.isNullOrBlank()) "DiskogsClient/0.0.1}" else s
        }
    }
}